...
#    return (controller1, controller2, hyper_params_dict, builder, state_logger, input_tail_logger, input_arm2_logger)
    return (controller, hyper_params_dict, builder, state_logger, input_tail_logger, input_arm2_logger)